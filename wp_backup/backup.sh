...
db_name="diaryofjaynewp"
db_username="diaryofjayneuser"
db_password=""7(*lWS82KzB"

## 2: Path to your WordPress Upload and Theme directories. Replace /home/username/ with path to your home directory.
wp_upload_folder="/var/www/diaryofjayne.ml/wp-content/uploads"
wp_theme_folder="/var/www/diaryofjayne.ml/wp-content/themes"
 
## 3: Path to your backup folder. Replace /home/username/ with path to your home directory.
backup_folder_path="/var/www/diaryofjayne.ml/wp_backup"
